class CD:
    ...
    def list_albums():
        ...
        for index, album in enumerate(CD.albums, start=1):
...
def main():
    while True:
        ...
        if choice == "0":
            ...
            artist = input("Artist:")
            title = input('Title:')
            CD.add_album(artist, title)
        elif choice == "2":
            artist = input("Artist:")
            title = input('Title:')
            CD.remove_album(artist, title)
        elif choice == "3":
            CD.list_albums()
        else:
